public class Main {
    //задание 1
    public static void printIssueCount(int number) {
        if (number > 1584 && number % 4 == 0 && number % 100 != 0 || (number > 1584 && number % 400 == 0)) {
            System.out.println(number + " " + "год високосный");
        } else {
            System.out.println(number + " " + "не год високосный");
        }
    }
    //задание 2
    public static void phoneYear(int phones, int year) {
